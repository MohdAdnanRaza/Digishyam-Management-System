...
const UserTable = ({ users }) => {
  ...
  return (
    <div className="w-full md:w-[350px] bg-black h-fit px-2 md:px-6 py-4 shadow-md rounded">
...
const Dashboard = () => {
  ...
  const Card = ({ label, count, bg, icon }) => {
    return (
      <div className="w-[220px] h-32 bg-white p-5 shadow-md rounded-md flex items-center justify-between  -mt-40">
        <div className="h-full flex flex-1 flex-col justify-between">
          <p className="text-base text-gray-600">{label}</p>
          <span className="text-2xl font-semibold">{count}</span>
          <span className="text-sm text-gray-400">{"2 last month"}</span>
        </div>
