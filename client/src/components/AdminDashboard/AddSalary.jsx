...
//               </td>
//               <td className="py-2 px-4 border">
//                 {salary.designation || "N/A"}
//               </td>
//               <td className="py-2 px-4 border">{salary.payAmount || "N/A"}</td>
//               <td className="py-2 px-4 border">
//                 {salary.salaryDate
//                   ? new Date(salary.salaryDate).toLocaleDateString()
//                   : "N/A"}
...
//         {Array.from(
//           { length: Math.ceil(filteredSalaries.length / salariesPerPage) },
//           (_, i) => (
//             <button
//               key={i}
...
//             <h2 className="text-xl mb-4">Add Salary</h2>
//             <form onSubmit={handleSubmit}>
//               <input
//                 type="text"
//                 placeholder="Employee Name"
