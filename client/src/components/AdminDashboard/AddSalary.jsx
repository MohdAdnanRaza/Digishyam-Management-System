            ...
            <div className="bg-white p-6 rounded-md shadow-md w-1/2 relative">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <input
                  ...
                  placeholder="Pay Amount"
                  className="w-full p-2 border mb-4 rounded-md"
                  value={salary.dueAmount}
                  onChange={(e) =>
                    setSalary({ ...salary, dueAmount: e.target.value })
                  }
                  required
                />
                <input
...
//   const [salariesPerPage] = useState(5);
//   const [isModalOpen, setIsModalOpen] = useState(false);
//   const [filterMonth, setFilterMonth] = useState(""); // For month filter
//   const [salary, setSalary] = useState({
//     employeeName: "",
//     designation: "",
//     payAmount: "",
...
//     };
//     fetchSalaries();
//   }, [filterMonth]); // Refetch data when the month filter changes
...
//               <td className="py-2 px-4 border">{indexOfFirstSalary + index + 1}</td>
//               <td className="py-2 px-4 border">{salary?.employeeName}</td>
//               <td className="py-2 px-4 border">{salary?.designation}</td>
//               <td className="py-2 px-4 border">{salary?.payAmount}</td>
//               <td className="py-2 px-4 border">{salary?.dueAmount}</td>
