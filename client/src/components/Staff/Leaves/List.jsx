...
const List = () => {
  ...
  return (
    ...
    //     <h3 className="text-2xl font-bold mx-7">Manage Leaves</h3>
    //   </div>
    ...
    //     <Link
    //       to="add-leave"
    //       className=" px-4 py-1 bg-teal-600 rounded text-white hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-500 w-100"
    //     >
    //       Add New Leave
    //     </Link>
    //   </div>
